...
model_urls = {
    ...
    'convnext_base_22k' : './models/convnext_base_22k_1k_224.pth',
    'convnext_large_22k' : './models/convnext_large_22k_224.pth',
...
def convnext_base(pretrained=False, in_22k=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(model_urls['convnext_base_22k']))
    return model
...
def convnext_large(pretrained=False, in_22k=True, **kwargs):
    ...
    if pretrained:
        ...
        # checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        # model.load_state_dict(checkpoint["model"])
        model.load_state_dict(torch.load(model_urls['convnext_large_22k']))
    return model
